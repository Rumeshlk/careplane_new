...
class PatientController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createFormBuilder($patient)
            ->add('first_name', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('last_name', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('dob', BirthdayType::class,array('attr'=>array('class'=>'input-sm','style' => 'margin-bottom:15px')))
            ->add('gender', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('bsn', IntegerType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('therapist', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('email', EmailType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('land_line', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('mobile_phone', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('address', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('zip_code', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('location', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('country', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('practitioner_name', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('Insurer', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('Policy_Number', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('add_insured', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('got_to_know_from', TextType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('value', MoneyType::class,array('attr'=>array('class'=>'form-control input-sm','style' => 'margin-bottom:15px')))
            ->add('save', SubmitType::class,array('label'=> 'Save','attr'=>array('class'=>'btn btn-primary input-sm','style' => 'margin-bottom:15px')))
            ->getForm();
